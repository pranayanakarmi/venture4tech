...
class TeamMemberSeeder extends Seeder {
    public function run(): void {
        $members = [
            ['name'=>'Pranay Nakarmi','position'=>'Founder & CEO','department'=>'Leadership','bio'=>'Pranay founded Sangam with a vision to make world-class software development accessible to businesses of all sizes. With 12+ years in tech, he leads the company strategy and client relations.','order'=>1],

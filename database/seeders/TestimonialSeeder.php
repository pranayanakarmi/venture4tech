...
class TestimonialSeeder extends Seeder {
    public function run(): void {
        $testimonials = [
            ['name'=>'Rajesh Kumar','position'=>'CTO','company'=>'MedCare Group','content'=>'Venture Four Technology delivered our healthcare platform on time and within budget. Their technical expertise in Laravel and AWS is exceptional. The team was responsive and proactive throughout the project.','rating'=>5,'order'=>1],

...
class HomeSectionSeeder extends Seeder {
    public function run(): void {
        ...
        HomeTestimonialsSection::create(['label'=>'Client Stories','title'=>'What Our Clients Say','description'=>'Don\'t just take our word for it. Here\'s what our clients have to say about working with Sangam.','is_active'=>true]);
